...
Another example can be that the Drones can ask for information about other Drones by requesting the Controller using GET  `https://controller/api/drone` or
GET `https://controller/api/status/<drone_id>`
